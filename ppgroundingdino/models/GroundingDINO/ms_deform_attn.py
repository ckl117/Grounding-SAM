...
class MSDeformableAttention(nn.Layer):
    ...
    def forward(self,
        ...
        # for k, v in zip(['reference_points', 'sampling_locations'], [reference_points, sampling_locations]):
        #     print(f'k: {k} v: {(paddle.isnan(v).any().item() or paddle.isinf(v).any().item())}')
